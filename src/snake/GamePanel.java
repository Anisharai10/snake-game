...
public class GamePanel extends JPanel implements ActionListener, KeyListener {
    ...
    int[] xPos={25,50,75,100,125,150,175,200,225,250,275,300,325,350,375,400,425,450,475,500,525,550,575,600,625,650,675,700,725,750};
...
//        throw new UnsupportedOperationException("not supported yet");
        ...
        if(snakeylength[0]<25)snakeylength[0]=850;

        if(snakexlength[0]>625)snakexlength[0]=75;
    ...
    public void newEnemy() {
         enemyX=xPos[random.nextInt(14)];
         enemyY=yPos[random.nextInt(13)];
